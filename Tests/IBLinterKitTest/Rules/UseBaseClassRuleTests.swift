...
class UseBaseClassRuleTests: XCTestCase {
    ...
    func testUseBaseClass() {
        ...
        let config = Config(disabledRules: defaultEnabledRules, enabledRules: [], excluded: [], included: [], customClassRule: [], customModuleRule: [], baseClassRule: [UseBaseClassConfig(elementClass: "UILabel", baseClasses: ["PrimaryLabel", "SecondaryLabel"])], reporter: "xcode")
